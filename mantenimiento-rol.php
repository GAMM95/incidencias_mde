...
require_once 'app/controllers/MantRolController.php';
$mantRolController = new MantRolController();
$mantRolModel = new MantRolModel();

if ($CodRol != '') {
  global $RolRegistrado;
  $RolRegistrado = $mantRolModel->obtenerRolPorId($CodRol);
  $mantRolController->registrarRol();

} else {
  $RolRegistrado = $mantRolModel->obtenerRolPorId($CodRol);
  //$mantRolController->actuaRol();
}
