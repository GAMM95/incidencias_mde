        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (index, value) {
                    select.append('<option value="' + value.CodCategoria + '">' + value.DescripcionCategoria + '</option>');
                });
                document.getElementById('categoria').value = '<?php echo $incidenciaRegistrada? $incidenciaRegistrada['CodCategoria']: ''; ?>';
            },
