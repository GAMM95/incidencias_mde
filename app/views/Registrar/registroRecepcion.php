        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (index, value) {
                    select.append('<option value="' + value.CodPrioridad + '">' + value.DescripcionPrioridad + '</option>');
                });
                document.getElementById('prioridad').value = '<?php echo $recepcionRegistrada? $recepcionRegistrada['CodPrioridad']: ''; ?>';
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                select.empty();
                $.each(data, function (index, value) {
                    select.append('<option value="' + value.CodImpacto + '">' + value.DescripImpacto + '</option>');
                });
                document.getElementById('impacto').value = '<?php echo $recepcionRegistrada? $recepcionRegistrada['CodImpacto']: ''; ?>';
